# -*- coding: utf-8 -*-
"""
Created on Sat Mar  4 15:27:10 2023
...
def plot_line():
    ...
    line_data = pd.read_excel(
        r"C:\\Users\\soura\\OneDrive\\Desktop\\data\\line.xlsx", index_col=0
    )
...
def plot_scatter():
    ...
    scatter_data = pd.read_csv(
        "C:\\Users\\soura\\OneDrive\\Desktop\\data\\scatered.csv"
    )

    # Create scatter plot
    plt.scatter(
        scatter_data["Country"],
        scatter_data["Maleria Deaths(Age-70+)"]
    )
